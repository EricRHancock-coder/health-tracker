...
/**
 * User Model (RedBeanPHP FUSE)
 * 
 * Handles user identity, authentication data, and role-based access.
 * Implements soft-delete via the is_disabled flag.
 * 
 * This class follows the RedBeanPHP FUSE naming convention: Model_{Table}.
 * For the 'users' table, the class must be named Model_Users.
 */
class Model_Users extends SimpleModel {
    /**
